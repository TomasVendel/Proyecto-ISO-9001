...
public class Proceso {
    ...
    private List<com.iso9001.models.Indicador> indicadores;
    ...
    // Métodos de negocio
    public void agregarIndicador(com.iso9001.models.Indicador indicador) {
        if (!indicadores.contains(indicador)) {
            indicadores.add(indicador);
        }
    }

    public void removerIndicador(com.iso9001.models.Indicador indicador) {
    ...
    public double calcularEficienciaGeneral() {
        ...
        return indicadores.stream()
                .mapToDouble(com.iso9001.models.Indicador::getValorActual)
                .average()
                .orElse(0.0);
    }
    ...
    public List<com.iso9001.models.Indicador> getIndicadores() { return new ArrayList<>(indicadores); }
    public void setIndicadores(List<com.iso9001.models.Indicador> indicadores) { this.indicadores = new ArrayList<>(indicadores); }
