...
public class NoConformidad {
    ...
    private List<com.iso9001.models.AccionCorrectiva> accionesCorrectivas;
    ...
    public void agregarAccionCorrectiva(com.iso9001.models.AccionCorrectiva accion) {
    ...
    public List<com.iso9001.models.AccionCorrectiva> getAccionesCorrectivas() { return new ArrayList<>(accionesCorrectivas); }
    public void setAccionesCorrectivas(List<com.iso9001.models.AccionCorrectiva> accionesCorrectivas) { this.accionesCorrectivas = new ArrayList<>(accionesCorrectivas); }
