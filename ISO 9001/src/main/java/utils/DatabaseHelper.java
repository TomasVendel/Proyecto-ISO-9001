...
public class DatabaseHelper {
    ...
    public static void guardarProcesos(List<com.iso9001.models.Proceso> procesos) {
        try (PrintWriter writer = new PrintWriter(new FileWriter(DATA_FOLDER + "procesos.csv"))) {
            ...
            // Escribir datos
            for (com.iso9001.models.Proceso proceso : procesos) {
    ...
    public static List<com.iso9001.models.Proceso> cargarProcesos() {
        List<com.iso9001.models.Proceso> procesos = new ArrayList<>();
        ...
        try (BufferedReader reader = new BufferedReader(new FileReader(archivo))) {
            ...
            while ((linea = reader.readLine()) != null) {
                ...
                if (datos.length >= 8) {
                    try {
                        com.iso9001.models.Proceso proceso = new com.iso9001.models.Proceso(
                                datos[0].trim(),                           // id
                                datos[1].trim(),                           // nombre
                                datos[2].replace("\"", "").trim(),         // descripcion
                                com.iso9001.enums.TipoProceso.valueOf(datos[3].trim()),      // tipo
    ...
    public static void guardarIndicadores(List<com.iso9001.models.Indicador> indicadores) {
        try (PrintWriter writer = new PrintWriter(new FileWriter(DATA_FOLDER + "indicadores.csv"))) {
            ...
            for (com.iso9001.models.Indicador indicador : indicadores) {
    ...
    public static List<com.iso9001.models.Indicador> cargarIndicadores() {
        List<com.iso9001.models.Indicador> indicadores = new ArrayList<>();
        ...
        try (BufferedReader reader = new BufferedReader(new FileReader(archivo))) {
            ...
            while ((linea = reader.readLine()) != null) {
                ...
                if (datos.length >= 9) {
                    try {
                        com.iso9001.models.Indicador indicador = new com.iso9001.models.Indicador(
                                datos[0].trim(),                               // id
                                datos[1].trim(),                               // nombre
                                datos[2].replace("\"", "").trim(),             // descripcion
                                com.iso9001.enums.TipoIndicador.valueOf(datos[3].trim()),        // tipo
    ...
    public static void guardarNoConformidades(List<com.iso9001.models.NoConformidad> noConformidades) {
        try (PrintWriter writer = new PrintWriter(new FileWriter(DATA_FOLDER + "no_conformidades.csv"))) {
            ...
            for (com.iso9001.models.NoConformidad nc : noConformidades) {
                writer.printf("%s,%s,\"%s\",%s,%s,%s,%s,%s,\"%s\"%n",
                        nc.getId(),
                        nc.getTitulo(),
                        nc.getDescripcion(),
    ...
    public static List<com.iso9001.models.NoConformidad> cargarNoConformidades() {
        List<com.iso9001.models.NoConformidad> noConformidades = new ArrayList<>();
        ...
        try (BufferedReader reader = new BufferedReader(new FileReader(archivo))) {
            ...
            while ((linea = reader.readLine()) != null) {
                ...
                if (datos.length >= 8) {
                    try {
                        com.iso9001.models.NoConformidad nc = new com.iso9001.models.NoConformidad(
                                datos[0].trim(),                                   // id
                                datos[1].trim(),                                   // titulo
                                datos[2].replace("\"", "").trim(),                 // descripcion
                                com.iso9001.enums.Prioridad.valueOf(datos[4].trim()),                // prioridad
                                datos[6].trim(),                                   // procesoAfectado
                                datos[7].trim()                                    // responsableDeteccion
                        );

                        nc.setEstado(com.iso9001.enums.EstadoNoConformidad.valueOf(datos[3].trim()));
    ...
    private static List<com.iso9001.models.Proceso> crearDatosEjemploProcesos() {
        List<com.iso9001.models.Proceso> procesos = new ArrayList<>();

        // Procesos Estratégicos
        procesos.add(new com.iso9001.models.Proceso("P001", "Planificación Estratégica", "Proceso de definición de objetivos y estrategias",
                com.iso9001.enums.TipoProceso.ESTRATEGICO, "Director General",
                "Establecer la dirección estratégica", "Toda la organización"));

        procesos.add(new com.iso9001.models.Proceso("P002", "Gestión de Calidad", "Proceso de gestión del sistema de calidad",
                com.iso9001.enums.TipoProceso.ESTRATEGICO, "Gerente Calidad",
                "Mantener certificación ISO 9001", "Todos los procesos"));

        // Procesos Operativos
        procesos.add(new com.iso9001.models.Proceso("P003", "Desarrollo de Productos", "Proceso de creación y desarrollo de nuevos productos",
                com.iso9001.enums.TipoProceso.OPERATIVO, "Jefe Ingeniería",
                "Desarrollar productos de calidad", "Área de I+D"));

        procesos.add(new com.iso9001.models.Proceso("P004", "Producción", "Proceso de fabricación de productos",
                com.iso9001.enums.TipoProceso.OPERATIVO, "Jefe Producción",
                "Fabricar productos según especificaciones", "Planta de producción"));

        procesos.add(new com.iso9001.models.Proceso("P005", "Ventas y Marketing", "Proceso de comercialización y ventas",
                com.iso9001.enums.TipoProceso.OPERATIVO, "Gerente Comercial",
                "Aumentar ventas y satisfacción del cliente", "Área comercial"));

        // Procesos de Apoyo
        procesos.add(new com.iso9001.models.Proceso("P006", "Gestión de Recursos Humanos", "Proceso de gestión del personal",
                com.iso9001.enums.TipoProceso.APOYO, "Jefe RRHH",
                "Gestionar el talento humano", "Toda la organización"));

        procesos.add(new com.iso9001.models.Proceso("P007", "Compras y Abastecimiento", "Proceso de adquisición de materiales",
                com.iso9001.enums.TipoProceso.APOYO, "Jefe Compras",
    ...
    private static List<com.iso9001.models.Indicador> crearDatosEjemploIndicadores() {
        List<com.iso9001.models.Indicador> indicadores = new ArrayList<>();
        Random random = new Random();

        // Indicadores para cada proceso
        indicadores.add(new com.iso9001.models.Indicador("I001", "Cumplimiento Objetivos Estratégicos", "Porcentaje de objetivos cumplidos",
                com.iso9001.enums.TipoIndicador.EFICACIA, "%", 90.0, "P001"));
        indicadores.get(0).setValorActual(85.0 + random.nextDouble() * 10);

        indicadores.add(new com.iso9001.models.Indicador("I002", "Satisfacción del Cliente", "Nivel de satisfacción general",
                com.iso9001.enums.TipoIndicador.SATISFACCION, "puntos", 4.5, "P005"));
        indicadores.get(1).setValorActual(4.2 + random.nextDouble() * 0.6);

        indicadores.add(new com.iso9001.models.Indicador("I003", "Tiempo Desarrollo Productos", "Tiempo promedio de desarrollo",
                com.iso9001.enums.TipoIndicador.TIEMPO, "días", 120.0, "P003"));
        indicadores.get(2).setValorActual(115.0 + random.nextDouble() * 20);

        indicadores.add(new com.iso9001.models.Indicador("I004", "Eficiencia Producción", "Productos por hora",
                com.iso9001.enums.TipoIndicador.EFICIENCIA, "unid/h", 50.0, "P004"));
        indicadores.get(3).setValorActual(45.0 + random.nextDouble() * 10);

        indicadores.add(new com.iso9001.models.Indicador("I005", "Defectos por Millón", "Cantidad de defectos por millón",
                com.iso9001.enums.TipoIndicador.CALIDAD, "ppm", 100.0, "P004"));
    ...
    private static List<com.iso9001.models.NoConformidad> crearDatosEjemploNoConformidades() {
        List<com.iso9001.models.NoConformidad> noConformidades = new ArrayList<>();

        noConformidades.add(new com.iso9001.models.NoConformidad("NC001", "Documento obsoleto en producción",
                "Se encontró un procedimiento desactualizado en el área de producción",
                com.iso9001.enums.Prioridad.MEDIA, "P004", "Auditor Interno"));

        noConformidades.add(new com.iso9001.models.NoConformidad("NC002", "Falta de calibración equipos",
                "Equipos de medición sin calibración vigente",
                com.iso9001.enums.Prioridad.ALTA, "P004", "Técnico Calidad"));

        noConformidades.add(new com.iso9001.models.NoConformidad("NC003", "Capacitación no documentada",
                "Personal sin evidencia de capacitación en ISO 9001",
                com.iso9001.enums.Prioridad.BAJA, "P006", "Jefe RRHH"));
