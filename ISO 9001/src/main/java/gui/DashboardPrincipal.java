...
public class DashboardPrincipal extends JFrame {
    ...
    private com.iso9001.managers.ProcesoManager procesoManager;
    private com.iso9001.managers.IndicadorManager indicadorManager;
    private com.iso9001.managers.NoConformidadManager noConformidadManager;
    private com.iso9001.managers.AuditoriaManager auditoriaManager;

    // Referencias a ventanas secundarias
    private com.iso9001.gui.VentanaProcesos ventanaProcesos;
    private com.iso9001.gui.VentanaIndicadores ventanaIndicadores;
    private com.iso9001.gui.VentanaNoConformidades ventanaNoConformidades;
    private com.iso9001.gui.VentanaAuditorias ventanaAuditorias;
    private com.iso9001.gui.VentanaReportes ventanaReportes;
    ...
    private void inicializarManagers() {
        try {
            ...
            this.indicadorManager = new com.iso9001.managers.IndicadorManager();
            this.procesoManager = new com.iso9001.managers.ProcesoManager(indicadorManager);
            this.noConformidadManager = new com.iso9001.managers.NoConformidadManager();
            this.auditoriaManager = new com.iso9001.managers.AuditoriaManager();
        ...
        try {
            if (procesoManager != null && indicadorManager != null) {
                if (ventanaProcesos == null || !ventanaProcesos.isDisplayable()) {
                    ventanaProcesos = new com.iso9001.gui.VentanaProcesos(procesoManager, indicadorManager);
                }
        ...
        try {
            if (indicadorManager != null) {
                if (ventanaIndicadores == null || !ventanaIndicadores.isDisplayable()) {
                    ventanaIndicadores = new com.iso9001.gui.VentanaIndicadores(indicadorManager);
        ...
        try {
            if (noConformidadManager != null) {
                if (ventanaNoConformidades == null || !ventanaNoConformidades.isDisplayable()) {
                    ventanaNoConformidades = new com.iso9001.gui.VentanaNoConformidades(noConformidadManager);
                }
        ...
        try {
            if (auditoriaManager != null) {
                if (ventanaAuditorias == null || !ventanaAuditorias.isDisplayable()) {
                    ventanaAuditorias = new com.iso9001.gui.VentanaAuditorias(auditoriaManager);
                }
        ...
        try {
            if (procesoManager != null && indicadorManager != null && noConformidadManager != null) {
                if (ventanaReportes == null || !ventanaReportes.isDisplayable()) {
                    ventanaReportes = new com.iso9001.gui.VentanaReportes(procesoManager, indicadorManager, noConformidadManager);
                }
